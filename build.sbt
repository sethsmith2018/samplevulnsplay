...
name := "samplevulns-play"
organization := "io.samplevulnsplay"
...
//  "org.mozilla.javascript" % "javascript" % "1.0",
...
dependencyOverrides += "org.javassist" % "javassist" % "3.22.0-GA"
dependencyOverrides += "com.mchange" % "mchange-commons-java" % "0.2.11"
dependencyOverrides += "org.clojure" % "clojure" % "1.8.0"
dependencyOverrides += "org.codehaus.groovy" % "groovy" % "2.3.9"
dependencyOverrides += "org.springframework" % "spring-expression" % "4.1.4.RELEASE"
dependencyOverrides += "org.springframework" % "spring-beans" % "4.1.4.RELEASE"
dependencyOverrides += "org.springframework" % "spring-context" % "4.1.4.RELEASE"
dependencyOverrides += "org.springframework" % "spring-core" % "4.1.4.RELEASE"
dependencyOverrides += "commons-collections" % "commons-collections" % "3.1"
dependencyOverrides += "org.apache.wicket" % "wicket-util" % "6.23.0"
dependencyOverrides += "aopalliance" % "aopalliance" % "1.0"
// dependencyOverrides += "org.mozilla.javascript" % "javascript" % "1.0"
// dependencyOverrides += "net.sf.json-lib" % "json-lib" % "2.4"
...
// always publish to local maven cache to avoid having to look in too many places when debugging
