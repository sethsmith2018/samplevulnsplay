# Sample play app full of nice vulnerabilities

# Package

```
$ sbt stage
$ file ./target/samplevulnsplay-0.0.1-SNAPSHOT.jar
```
...
```
$ sbt assembly
$ java -Dplay.server.http.port="8082" -Dplay.server.http.address="127.0.0.1" -jar ./target/samplevulnsplay-assembly-0.0.1-SNAPSHOT.jar
```
